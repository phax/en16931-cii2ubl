...
* The BT-3 (Invoice type code) sets are now edition specific. EN 16931:2017 follows the EN 16931 validation artefacts, against which this project validates its UBL 2.1 output; EN 16931:2026 follows the code list published by CEN/TC 434, which is normative for that edition. The artefacts accept seven codes the published list does not (`471`, `472`, `473`, `500`, `501`, `502`, `503`) and additionally allow `81` on an Invoice, so a document with BT-3 = `81` becomes an Invoice under 2017 and a CreditNote under 2026
