...
import oasis.names.specification.ubl.schema.xsd.commonaggregatecomponents_24.*;
import oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_24.*;
...
/**
 * CII to UBL 2.4 converter.
 *
 * @author Philip Helger
 * @since 2.1.0
 */
public class CIIToUBL24Converter extends AbstractCIIToUBLConverter <CIIToUBL24Converter>
{
  private static final String UBL_VERSION = "2.4";

  public CIIToUBL24Converter ()
  {}

  @Nullable
  private static oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_24.IDType _copyID (@Nullable final IDType aCIIID)
  {
    return _copyID (aCIIID, new oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_24.IDType ());
  }

  @Nullable
  private static oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_24.NoteType _copyNote (@Nullable final un.unece.uncefact.data.standard.reusableaggregatebusinessinformationentity._100.NoteType aNote)
  {
    if (aNote == null)
      return null;

    final oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_24.NoteType aUBLNote = new oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_24.NoteType ();
  ...
  @Nullable
  private static oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_24.NoteType _copyNote (@Nullable final TextType aText)
  {
    return _copyName (aText, new oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_24.NoteType ());
  }
  ...
  @Nullable
  private static oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_24.IDType _extractFirstPartyID (@Nonnull final TradePartyType aParty)
  {
    final IDType aID;
  ...
  private static void _extractAllPartyIDs (@Nonnull final TradePartyType aParty,
                                           @Nonnull final Consumer <? super oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_24.IDType> aIDConsumer)
  {
    if (canUseGlobalID (aParty))
  ...
  private static void _addPartyID (@Nullable final oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_24.IDType aUBLID,
  ...
  @Nullable
  private static oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_24.AmountType _copyAmount (@Nullable final AmountType aAmount,
  ...
  private void _convertPaymentMeans (@Nonnull final HeaderTradeSettlementType aHeaderSettlement,
                                     ...
                                     @Nonnull final Consumer <oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_24.IDType> aSellerIDHandler,
                                     ...
                                     @Nonnull final ErrorList aErrorList)
  {
    ...
    if (bIsBG19)
    {
      ...
      {
        final oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_24.IDType aSellerID = _copyID (aCreditorRefID);
                                       ...
                                       @Nonnull final ErrorList aErrorList)
  {
    ...
    // Delivery
    {
      ...
      if (aShipToParty != null)
      {
        ...
        final oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_24.IDType aUBLID = _extractFirstPartyID (aShipToParty);
        if (aUBLID != null)
        {
    ...
    for (final SupplyChainTradeLineItemType aLineItem : aSCTT.getIncludedSupplyChainTradeLineItem ())
    {
      ...
      if (aLineBillingPeriod != null)
      {
        ...
        if (aLineBillingPeriod.getStartDateTime () != null)
          aUBLLinePeriod.setStartDate (_parseDate (aLineBillingPeriod.getStartDateTime ().getDateTimeString (),
                                                   aErrorList));
        if (aLineBillingPeriod.getEndDateTime () != null)
          aUBLLinePeriod.setEndDate (_parseDate (aLineBillingPeriod.getEndDateTime ().getDateTimeString (),
                                                 aErrorList));
