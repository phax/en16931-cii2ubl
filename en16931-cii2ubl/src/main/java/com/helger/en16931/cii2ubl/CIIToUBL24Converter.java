...
public class CIIToUBL24Converter extends AbstractCIIToUBLConverter <CIIToUBL24Converter>
{
  ...
  {
    return copyID (aCIIID, new oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_24.IDType ());
  }
  ...
  {
    return copyName (aText, new oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_24.NoteType ());
  }
  ...
  {
    return copyAmount (aAmount, new oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_24.AmountType (), sDefaultCurrencyCode);
  }
