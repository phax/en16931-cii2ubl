...
public class CIIToUBL24Converter extends AbstractCIIToUBLConverter <CIIToUBL24Converter>
{
  ...
  private static oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_24.@Nullable IDType _copyID (@Nullable final IDType aCIIID)
  {
  ...
  private static oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_24.@Nullable NoteType _copyNote (final un.unece.uncefact.data.standard.reusableaggregatebusinessinformationentity._100.@Nullable NoteType aNote)
  {
    if (aNote == null)
      return null;
  ...
  private static oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_24.@Nullable NoteType _copyNote (@Nullable final TextType aText)
  {
  ...
  private static oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_24.@Nullable IDType _extractFirstPartyID (@NonNull final TradePartyType aParty)
  {
    final IDType aID;
  ...
  private static void _addPartyID (final oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_24.@Nullable IDType aUBLID,
                                                ...
                                                @NonNull final PartyType aUBLParty)
  {
    ...
    if (!bExistingLegalEntity)
    {
      if (aUBLPartyLegalEntity.getRegistrationName () != null ||
          ...
          !aUBLPartyLegalEntity.getCompanyLegalForm ().isEmpty ())
  ...
  private static oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_24.@Nullable AmountType _copyAmount (@Nullable final AmountType aAmount,
